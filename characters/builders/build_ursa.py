...
gear = [
    ...
    ('Ash&rsquo;s Sigil-Stone<br/><i>(new! found on the trail east)</i>',
     ...
     '<b>Aura of Vitality</b> free once a day (no slot): an <b>action</b> to light a 30-ft aura, then he heals one creature in it for <b>2d6</b> right away and again at the start of each of his turns. It takes <b>Concentration</b> (up to 1 minute), so he cannot hold a summon at the same time, and the heals themselves cost him <b>no action</b>. Out of a fight, just run the whole minute. <br/><b>2 charges, and these are for the stone&rsquo;s visions, not the healing</b> (all back at dawn), magic action to spend one: <b>Ask the Day</b> (one truthful yes or no about the day ahead, <i>or silence if it cannot be known</i>), <b>Glimpse the Trail</b>, or <b>Read the Heart</b>. <i>(A keepsake, not a bonded relic: it needs <b>no attunement</b>.)</i>'),
