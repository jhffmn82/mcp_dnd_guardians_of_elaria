...
gear=[
    ('Nichirin Katana <i>(new! the demon-slayer&rsquo;s blade)</i>','Sun-forged crimson steel, <b>+2</b> to hit and damage, and it counts as a Monk weapon. <b>Breath-Kindled Steel:</b> it glows blood-red when he ignites. <b>Cleansing Edge:</b> once a turn, on <b>a hit he chooses</b>, when he strikes a fiend, undead, shadow thing or anything twisted by planar corruption, that creature <b>cannot heal</b> and cannot hide from him in darkness until his next turn. <b>Attuned.</b>'),
