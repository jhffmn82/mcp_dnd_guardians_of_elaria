# The History of Elaria: The Chronicler's Bible

The single source of truth for world-lore fragments ("Lore of Elaria" boxes) peppered
through the book. Everything here is ADDITIVE lore built on established canon
(memory/campaign_canon.md, frontmatter/lore_primer.docx). It invents history, never
table events. Kid-friendly, mythic, no em dashes. Each fragment below is written to be
dropped into the book verbatim or lightly trimmed, and tagged with where it lands well.

## THE FOUR AGES (the spine)

The world counts its history in four ages: **the Weaving**, when the planes were set
turning; **the War of Fractures**, when the Weaver of Fractures tried to pull them
apart; **the Long Peace**, a thousand quiet years bought by the Warden's sacrifice;
and **the Darkening**, now, when the anchor-stars have begun to go out.

---

## Fragments: The Weaving (creation myths)

**W1. The Clockmaker's Gift** (any cosmology/star page)
...
**W2. The First Listeners** (forest/druid pages)
...
**W3. The Delvers** (Glimmerspire/deep gnome pages)
...
**W4. The Thorn Clans** (goblin/Bloodthorn pages)
...
**W5. The Stone Rings** (stone circle/Duckleaf pages)
...
## Fragments: The War of Fractures (the great myth)

**F1. The Weaver of Fractures** (villain/shadow pages)
Maldrith did not hate the world. The old verses are careful about this. She was hunger
given patience, a thing from beyond the walls that wanted in, and the walls, being
made of starlight, could only hold if someone kept the stars lit.

**F2. The Warden's Price** (Elaria pages)
...
**F3. The Scattered Safeguards** (relic/bell/potato pages)
...
**F4. The Old Shrine** (east/shrine/Ash pages)
Far east of the sea stands the shrine where, the elders say, the Warden stood last
before her long sleep. Pilgrims once walked a year to reach it. The road is forgotten
now, which troubles the Circle less than the fact that something else seems to have
remembered it.

**F5. The Bells of the Coast** (Havenmoor/bells pages)
...
## Fragments: The Long Peace (the thousand years)

**L1. The Founding of Glimmerspire** (Glimmerspire/Lilly pages)
Glimmerspire began as a single lamp in Deepforge Hollow, lit by a tinkerer who wanted
to read after supper. The academy that grew around that lamp now teaches its
first-years the founding law: understand a thing before you improve it, and improve it
before it breaks.

**L2. The Sky-Readers** (Ursa/Circle/star pages)
...
**L3. The Whispering Breeze Monastery** (Stabby/monk pages)
...
**L4. The Raising of Gearhaven** (Gearhaven pages)
...
**L5. The Made Folk** (Mechagnome pages)
The Mechagnomes were made, and then, as happens with anything loved and talked to for
long enough, they simply were. No one in Gearhaven can point to the day the made folk
became folk. The city's oldest law is that nobody has to.

**L6. The House of Ravenstone** (Ravenstone/Aelwyn pages)
...
**L7. The Gilded Curtain** (Wraithpine/theater pages)
...
**L8. The Open Sea Trade** (sea/harbor pages)
For a thousand years the Open Sea was a friendly road: grain west, brass east, and
songs both ways. Sailors of the old trade knotted a keepsake into the rigging before
every crossing, a button, a ribbon, a name, so the sea would know they meant to come
back for it.

**L9. The Legend of the Dutchman** (Davy Jones/ghost ship pages)
Every coast tells it differently, but the bones agree: a captain who could not bear to
lose what he loved bargained with something in the deep water to keep it, and the
bargain kept HIM instead. The old sailors' rule survives the legend: whatever the sea
takes, let it go, or it will hold you to the letter of the trade.

**L10. The Vale Villages** (Eldridge/Oakshade pages)
...
**L11. The Grove Roads** (wilds/meadow/thicket pages)
...
**L12. The Enchanted Potatoes** (potato/Ash pages)
...
## Fragments: The Darkening (now; ties to the chronicle)

**D1. The First Star Out** (Betelgeuse/Ash pages)
...
**D2. Motes** (mote/wondrous creature pages)
...
**D3. The Machines Remember** (Gearhaven/machine pages)
Machines feel the Darkening before people do. A machine is a promise written in brass,
and promises are exactly what the Weaver of Fractures unpicks first. When the mills
and servitors of the world began to stumble, the made folk of Gearhaven understood it
the way sailors understand a red sky.

**D4. Why the Guardians** (party/heroes pages)
...
- Fragments are placed in "Lore of Elaria" boxes (the ("lore", title, text) engine
  block) on pages with large art and light text.
- Adapt length to the gap, but never contradict a fragment's facts; if trimming,
  trim whole sentences.
- Each fragment should sit on a page RELEVANT to its tag.
- These are legends and histories told in-world: hedge words like "the old tales say"
  keep them safely mythic.
- New fragments must be added to this file first, then placed.
