<!-- SRD 5.2.1 (CC-BY-4.0), pages 123-142. Faithful transcription; the PDF at reference/SRD_CC_v5.2.1.pdf is authoritative. -->

# Spell Descriptions (D–I)

## Demiplane

<!-- gap: this spell begins on page 122, before the transcribed range; the text below continues it -->
...
<!-- gap: the Incendiary Cloud description continues past page 142, beyond the transcribed range -->
