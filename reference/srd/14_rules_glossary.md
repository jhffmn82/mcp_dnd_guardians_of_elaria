<!-- SRD 5.2.1 (CC-BY-4.0), pages 176-191. Faithful transcription; the PDF at reference/SRD_CC_v5.2.1.pdf is authoritative. -->
...
|---|---|---|---|
| AC | Armor Class | LN | Lawful Neutral |
| C | Concentration | M | Material component |
| CE | Chaotic Evil | N | Neutral |
| CG | Chaotic Good | NE | Neutral Evil |
| Cha. | Charisma | NG | Neutral Good |
| CN | Chaotic Neutral | NPC | Nonplayer character |
| Con. | Constitution | PB | Proficiency Bonus |
| CP | Copper Piece(s) | PP | Platinum Piece(s) |
| CR | Challenge Rating | R | Ritual |
| DC | Difficulty Class | S | Somatic component |
| Dex. | Dexterity | SP | Silver Piece(s) |
| EP | Electrum Piece(s) | Str. | Strength |
| GM | Game Master | V | Verbal component |
| GP | Gold Piece(s) | Wis. | Wisdom |
| HP | Hit Point(s) | XP | Experience Point(s) |
| Int. | Intelligence | | |
| LE | Lawful Evil | | |
| LG | Lawful Good | | |
