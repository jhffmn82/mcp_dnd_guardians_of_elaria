<!-- SRD 5.2.1 (CC-BY-4.0), pages 5-18. Faithful transcription; the PDF at reference/SRD_CC_v5.2.1.pdf is authoritative. -->

<!-- Page 5 opens with two rules sidebars carried over from the preceding "Reading the Rules" material, transcribed here as they appear on the page. -->
...
| Pace | Distance Per Minute | Distance Per Hour | Distance Per Day |
| --- | --- | --- | --- |
...
**Ranged Attacks in Close Combat.** Aiming a ranged attack is more difficult when a foe is next to you. When you make a ranged attack roll with a weapon, a spell, or some other means, you have Disadvantage on the roll if you are within 5 feet of an enemy who can see you and doesn't have the Incapacitated condition (see "Rules Glossary").
...
**Reach.** A creature has a 5-foot reach and can thus attack targets within 5 feet when making a melee attack. Certain creatures have melee attacks with a reach greater than 5 feet, as noted in their descriptions.
