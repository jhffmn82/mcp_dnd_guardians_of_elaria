<!-- SRD 5.2.1 (CC-BY-4.0), pages 19-27. Faithful transcription; the PDF at reference/SRD_CC_v5.2.1.pdf is authoritative. -->
...
| Wizard | 8 | 12 | 13 | 15 | 10 | 14 |

<!-- gap: the Wis. and Cha. columns of Standard Array by Class wrapped as free-floating number pairs in the PDF text layer; reconstructed by class from the SRD standard array. Str/Dex/Con/Int read directly from each row. -->
