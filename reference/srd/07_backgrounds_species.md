<!-- SRD 5.2.1 (CC-BY-4.0), pages 82-85. Faithful transcription; the PDF at reference/SRD_CC_v5.2.1.pdf is authoritative. -->

# Character Origins: Backgrounds and Species

<!-- Page 82 continues the Wizard class from the previous chapter; transcribed here because it falls within the requested page range. -->
...
<!-- gap: the Goliath entry continues beyond page 85 (additional traits such as Large Form and Powerful Build) on page 86, which is outside the requested page range. -->
