<!-- SRD 5.2.1 (CC-BY-4.0), pages 53-63. Faithful transcription; the PDF at reference/SRD_CC_v5.2.1.pdf is authoritative. -->

# Classes: Paladin, Ranger, Rogue
...
(Prepared Spells and the Spell Slots per Spell Level, columns 1-5, follow the Channel Divinity column.)
...
(Prepared Spells and the Spell Slots per Spell Level, columns 1-5, follow the Favored Enemy column.)
...
<!-- gap: The Rogue Subclass: Thief (Levels 3-17) begins on page 64, which is outside the assigned page range 53-63 and is not transcribed here. -->
