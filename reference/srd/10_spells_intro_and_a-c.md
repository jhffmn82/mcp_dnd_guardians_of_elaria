<!-- SRD 5.2.1 (CC-BY-4.0), pages 103-122. Faithful transcription; the PDF at reference/SRD_CC_v5.2.1.pdf is authoritative. -->

<!-- Pages 103 opens mid-section within the Magic Items / Crafting rules (continued from the prior page); the Spells section proper begins on page 104. -->

## Wearing and Wielding Items

(continued) ...the item. You can also voluntarily end Attunement by spending another Short Rest focused on the item unless the item is cursed.
...
<!-- gap: The Demiplane spell's description text continues onto page 123, which is beyond the requested page range (103-122). Only the spell's header block (level/school, casting time, range, components, duration) appears on page 122. -->
