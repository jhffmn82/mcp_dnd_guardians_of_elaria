<!-- SRD 5.2.1 (CC-BY-4.0), pages 161-175. Faithful transcription; the PDF at reference/SRD_CC_v5.2.1.pdf is authoritative. -->

# Spell Descriptions (continued)

<!-- gap: This chunk opens mid-spell. The following paragraph is the tail end of Seeming, which begins on page 160 (outside this range). -->
...
<!-- gap: The Telekinesis description ends mid-sentence at "manipulating a simple tool," in the source PDF; no further text follows before the Telepathic Bond heading. Transcribed verbatim as printed. -->
...
<!-- gap: The Teleportation Outcome table was garbled by two-column PDF extraction; reconstructed from all recovered numeric fragments (each cell verified against the source text). Ranges ending in "00" denote 100. -->
