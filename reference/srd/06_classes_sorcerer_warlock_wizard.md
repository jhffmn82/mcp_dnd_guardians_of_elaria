<!-- SRD 5.2.1 (CC-BY-4.0), pages 64-81. Faithful transcription; the PDF at reference/SRD_CC_v5.2.1.pdf is authoritative. -->

<!-- gap: Printed page 64 opens with the tail of the Rogue Subclass: Thief (Fast Hands, Second-Story Work, Supreme Sneak, Use Magic Device, Thief's Reflexes), which belongs to the preceding Rogue section and is omitted here. This file begins at the Sorcerer, the first class in the requested Sorcerer/Warlock/Wizard section. -->
...
<!-- gap: The Wizard spell list continues beyond printed page 81 with Level 8 and Level 9 Wizard Spells and the Wizard Subclass: Evoker, which fall on printed page 82+ and are outside the requested pages 64-81 range. -->
