...
- **R1 (S7): CONFIRMED ERROR, needs DM sign-off.** SRD Monk Level 3 *Deflect Attacks*: "When an attack roll hits you and its damage includes Bludgeoning, Piercing, or Slashing damage..." It extends to "any damage type" only at Level 13 (*Deflect Energy*). At level 5, Stabby cannot legally Deflect the Custodian's Chain Lightning Burst. The S7 note already offers fallbacks. APPLIED (DM chose "deflect a physical hit"): the beat now has the giant tear a jagged slab of clockwork loose and hurl it; Stabby stills and turns the slab aside (Bludgeoning, legal at level 5). The Chain Lightning Burst stays as the phase threat, answered by Lilly's Shield, Absorb Elements, a Dexterity save, and Ghostbloom. Door 2's tease and the DM tactical notes were updated to match, and the boss stat block cues Stabby's Deflect awakening on the physical Clockwork Barrage.
