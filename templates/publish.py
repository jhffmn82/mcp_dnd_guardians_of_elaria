...
# per-hero builder from that folder). Publish does NOT regenerate them here,
# because build_lilly.py and build_stabby.py are still stale snapshots and
# would overwrite the current sheets; only build_ursa.py is synced so far.
CHAR_SHEETS = [
