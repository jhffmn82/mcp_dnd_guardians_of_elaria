...
- Lilly's spell list, 2024 legality pass (DM, 2026-08-13): Absorb Elements, Catapult, Snare and Tasha's Caustic Brew were removed. All four were 2014-era artificer spells and none appear on the 2024 Forge-of-the-Artificer list (verified on dnd2024.wikidot.com); her sheet was also preparing 7 where level 5 allows 6. Her prepared six are now Faerie Fire, Grease, Cure Wounds (1st) and Homunculus Servant, Dragon's Breath, Aid (2nd), with Shield, Thunderwave, Scorching Ray and Shatter still free from Artillerist. The Session 7 boss text no longer offers Absorb Elements as an answer to the Chain Lightning Burst: Shield still works, because the burst's primary target is an attack roll, and the arcs are Dex saves.
