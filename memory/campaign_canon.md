...
- Timeskip doors (chosen at/before Session 8): A stay and build with Vane, B home to Glimmerspire and Poots, C mote researcher. Rewards are PATH FEATS since the 2026-07-31 conversion (commits 038b087 + 99ed4b4): A Sentinel Protocol, B Stormgunner, C Aether Channeler; Boomstick is the base weapon on every road, and the old item rewards (Sentinel construct item, Wand of the War Mage, Awakened Sphere item) are superseded. See reference/campaign/lilly_kit.md. Door pick NOT yet made.
...
| 5 | The Curse of Davy Jones | 4 (leveled to 5 after this session, DM ruling) | Voyage on the Stormwind; storm and capsize; the Flying Dutchman; essence-harvest operation with Artificers' Guild-stamped crates; Davy Jones destroyed; dice game won; Ghost essence extracted and infused into Floraburst, beginning her change. The players ROLLED at the table to determine what Floraburst would become and did not learn the result during the session (DM-confirmed 2026-07-06). She remains a sleeping, glowing Floraburst through the end of Session 5; art and text must never show Ghostbloom before the Session 6 emergence. |
| 6 | Lanterns in the Fog (Wraithpine) | 5 | False Hydra's song of unremembering; Harlan Wicke; tavern head destroyed; lair fight under the Old Theater; the chest with three relics; Ghostbloom fully emerges (the payoff of the S5 roll: Floraburst evolved into a Ghost type by the Dutchman's ghost essence); the idol appears in Stabby's bag after departure (discovered later, C13). |
...
| 8 (planned) | Reunion + Earth Rift | 7 | Cold-open reunion at the finished portal; first rift run; Groudon (Earth-rift legendary); Antares relights. |
...
- Star map (must match the Session 7 orrery plate, `assets/session_07/beat_3/orrery_reacts.png`, which is CANON per DM 2026-08-18 and shows THREE dark stars, one unlabeled): Fire/Ignis = Aldebaran (bright at S7; FLICKERING, UNDER ATTACK from S8's epilogue on, DM ruling 2026-08-18); Water/Unda = Fomalhaut (same: flickering, under attack); Air/Aer = Vega (going dark); Earth/Terra = Antares (was dimming; RELIT in Session 8); Shadow/Umbra = Algol (dark); Betelgeuse = the FIRST star put out, the one Ash chased; Achernar = the RESERVE anchor, held back against the worst, currently anchoring nothing; and THE NAMELESS (DM 2026-08-18, canonizing the unlabeled dark star in the orrery plate) = a star crossed off the Circle's list so long ago that no living sky-reader knows its name or what world it held. The Nameless is WHY the reserve exists: it is the proof of what happens when a star stays dark too long. Its world was not saved. Nobody talks about it.
...
- **The star map is a scoreboard, not scenery.** After Session 8 the two remaining lit anchors are FLICKERING, both at once, which is not how stars die on their own: Nyxthid is attacking both. Put them out on screen and the clock becomes real. The Nameless hangs there as the quiet worst case.
...
- pokemon_encounters.docx (moved to _triage/superseded_working_docs/ during the 2026-07-11 consistency pass): an old PLANNING list, not a play record (its S6-S9 entries do not match played sessions). Only S1-S3 entries aligned with play. Do not cite as canon.
